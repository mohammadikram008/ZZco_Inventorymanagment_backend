...
const { addBank, getAllBanks, deleteBank, updateBank ,getTransactionHistory, addBankTransaction} = require("../controllers/bankController");
...
router.post("/:id/transaction", protect, addBankTransaction);
